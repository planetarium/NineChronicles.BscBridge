...
describe(MultiPlanetary.name, () => {
  ...
  describe("Check Methods of MultiPlanetary", () => {
    it("isMultiPlanetRequest", () => {
      expect(multiPlanetary.isMultiPlanetRequestType(defaultRequest)).toEqual(
        false
      );

      expect(multiPlanetary.isMultiPlanetRequestType(odinRequest)).toEqual(
        true
      );

      expect(multiPlanetary.isMultiPlanetRequestType(heimdallRequest)).toEqual(
        true
      );
    ...
    it("getRequestPlanetName", () => {
      expect(multiPlanetary.getRequestPlanetName(invalidPlanetRequest)).toEqual(
        "odin"
      );
      ...
      expect(multiPlanetary.getRequestPlanetName(odinRequest)).toEqual("odin");

      expect(multiPlanetary.getRequestPlanetName(heimdallRequest)).toEqual(
        "heimdall"
      );
    });
    ...
    it("isMainPlanetRequest", () => {
      ...
      expect(multiPlanetary.isMainPlanetRequest("heimdall")).toEqual(false);

      expect(multiPlanetary.isMainPlanetRequest("otherPlanet")).toEqual(false);
    });
